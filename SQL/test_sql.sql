...
--- Run all the queries in the file data_query.sql
--- This will create a database called test_sql_db

-- Run the below query to use the Database and solve all the questions
-- The query to use the database in
USE test_sql_db;
